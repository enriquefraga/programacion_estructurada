...
void  crearEstudiante ( struct student * estudiante, int studentId, char firstName [], char firstLastName [], char secondLastName [], char birthDate [], char school [], char grade [], char carrera [], char gender [] );
vacío  saludarEstudiante ( struct student * estudiante);
...
int  main ()
{
	...
	bool valido;
	int temp, studentId;
	char firstName [ '  ' ], firstLastName [ '  ' ], secondLastName [ '  ' ], birthDate [ '  ' ], school [ '  ' ], grade [ '  ' ], carrera [ '  ' ], género [ '  ' ];
	
	/*Control de registro de estudiantes*/
	hacer
	{
		printf ( " \ t \ t \ t \ t \ t \ t \ t -REPORTE- \ n \ n " );
...
void crearEstudiante(struct student *estudiante, int studentId, char firstName[], char firstLastName[], char secondLastName[], char birthDate[], char school[], char grade[], char career[], char gender[])
{
	...
	strcpy (estudiante-> género , género);
}

vacío  saludarEstudiante ( struct student * estudiante)
{
	printf ( " ¡Acabas de registrador a % s ! \ n " , estudiante-> firstName );
}
